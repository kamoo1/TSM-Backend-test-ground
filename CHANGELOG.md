...
* ci: release db on tag `db`

BREAKING CHANGE: client now unable to fetch from `latest` tag ([`903a2a1`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/903a2a1cc3f80428b960b28a4c84551889a0839b))
...
* chore: bump `pydantic` to 2.x ([`7e34254`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/7e342548d66e9cb5d865f6ee057f57efc9a816bd))
...
* chore: add patch for `LibRealmInfo` ([`0f8798e`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/0f8798e909b194cca5b1e7d47b1c7080ddf6af98))
...
* ci: fix ci ([`7ea0eb7`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/7ea0eb7e94600cb8fe6c6267907efd7479b6a7cc))

* ci: fix ci ([`d5fffe5`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/d5fffe56d6e52d51f64b0b0e2884432e4d0c2ceb))

* ci: fix ci, for the love of everything, it&#39;s time ([`6860e99`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/6860e99e6cc20dacfcbf1e0467933d8c5b771ba1))

* ci: fix ci ([`72bc5c2`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/72bc5c2881c9944310e8e26a527aaacc26f7ee15))

* ci: fix ci ([`cf8e936`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/cf8e9367311b2d368b5e5e530c20c16fc1e323d2))

* ci: fix ci ([`1de3f6d`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/1de3f6dc55bd3ef5f4c04ea4a99f45dee36fa370))

* ci: fix ci ([`3fb5257`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/3fb52577bd9640a9585678f98aaf41b39bc06be4))

* ci: fix ci ([`738165a`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/738165a28d8ec008899156dbd60b26fc5954ce31))

* ci: fix ci ([`75f941f`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/75f941f2b6311148b2907b10b6bcc2777ed08401))

* ci: i&#39;m kinda shooting in the dark here ([`342499a`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/342499a80023928c3c2e1ec805bb5410380962ac))

* ci: update release ci permission ([`7c2e36d`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/7c2e36d635f8fc64f8204af4e45fcd19721e2ea7))

* ci: fix order ([`13981c7`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/13981c7c98cd1f2b957268c5a96594205a9a0bdd))

* ci: fix typo ([`c08a691`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/c08a691de11fa50aa1db7308d638622fa9e73082))

* ci: automate build and versioning ([`7d27e21`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/7d27e2169a9de48501290fcf5a5faea3437459a2))

* ci: only update `classic tw` for testing ([`36b43f6`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/36b43f664b9908b3e27b07c5ad5c74a7ff21566e))
...
* feat: add text file patcher ([`4be74eb`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/4be74ebe63ca12fae20cbdae15c30c4258660eaf))
...
ci: fix ci ([`179877c`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/179877c1a2937a29613a27738f2f80cd46b7c735))

* Merge pull request #14 from kamoo1/dev

ci: fix ci ([`10139ff`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/10139ff006e6a8c8c1e38e55880320e20b1e5b2b))

* Merge pull request #13 from kamoo1/dev

ci: fix ci, for the love of everything, it&#39;s time ([`a261a0e`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/a261a0e4ed656d2343b54bc37b3aba1552e46879))

* Merge pull request #12 from kamoo1/dev

ci: fix ci ([`2b4da0c`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/2b4da0c09797570a5cb2319907c725b34af0e00b))

* Merge pull request #11 from kamoo1/dev

chore: bump `pydantic` to 2.x ([`dd9eb56`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/dd9eb565dad16a5a93abc4a77f817b61893b2190))

* Merge pull request #10 from kamoo1/dev

ci: fix ci ([`e0b8db3`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/e0b8db339d362c10893222e26babd98747724dfe))

* Merge pull request #9 from kamoo1/dev

ci: fix ci ([`4da05d2`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/4da05d2caa29e466f863b69b1a2b4464bd49189f))

* Merge pull request #8 from kamoo1/dev

ci: fix ci ([`49845c4`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/49845c493209d3b5612ea8c6cc7fceb2440a6f35))

* Merge pull request #7 from kamoo1/dev

ci: fix ci ([`cd69e2f`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/cd69e2ff4420378fc20f8b631eb1fefda7f06b1c))

* Merge pull request #6 from kamoo1/dev

ci: fix ci ([`ea60464`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/ea60464944627b5c87bffc08d42a8f75b3a6fd3e))

* Merge pull request #5 from kamoo1/dev

ci: i&#39;m kinda shooting in the dark here ([`82ce83f`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/82ce83fb80ac9e3a269c0d4f330d190f509d76de))

* Merge pull request #4 from kamoo1/dev

ci: update release ci permission ([`0af43bd`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/0af43bdeb20d7eb3cd0b5b10445b3a3fcefec2fb))

* Merge pull request #3 from kamoo1/dev

ci: fix order ([`f02f3d6`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/f02f3d6eff5ef7a0f5deaaf43d270fc2e3fbe771))

* Merge pull request #2 from kamoo1/dev

ci: fix typo ([`23c4f91`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/23c4f91c08cbc5e34dcee068dbfd74858913df18))

* Merge pull request #1 from kamoo1/dev

Dev ([`2ab2ac3`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/2ab2ac31d93f7398b2476e3c85f85659b51717b3))
...
* update readme ([`dc36274`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/dc362740044f2e15104c78ba5a33d7b3143f4b04))
...
* add caching for pip in cicd ([`75caf0b`](https://github.com/kamoo1/TSM-Backend-test-ground/commit/75caf0b7fce76d8609374bfd53668bd0da32dadf))
